...
public class SslSuite extends AbstractGremlinSuite {

    private static final Class<?>[] allTests = new Class<?>[]{
            SslConnectionTest.class
    };

    public SslSuite(final Class<?> klass, final RunnerBuilder builder) throws InitializationError {
